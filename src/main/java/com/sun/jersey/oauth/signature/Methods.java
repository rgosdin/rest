...
class Methods {
    ...
    private static HashMap<String, OAuthSignatureMethod> loadMethods() {
        ...
        CLASS_LOGGER.debug("Loading oauth signature methods...");
        ...
        for (OAuthSignatureMethod method : ServiceFinder.find(OAuthSignatureMethod.class, true)) {
            CLASS_LOGGER.debug("Method name: " + method.name());
            CLASS_LOGGER.debug("Method class: " + method.getClass().getSimpleName());
